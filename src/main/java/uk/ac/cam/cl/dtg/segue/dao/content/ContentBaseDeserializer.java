 ...
 * 
 * All content objects MUST have a type property set for this to work - the
 * default behaviour is to try and create a plan content object if we are in
 * doubt.
 * 
 */
	...
	public final Content deserialize(final JsonParser jsonParser,
		...
		if (null == typeMap) {
			throw new IllegalStateException(
					"No Map provided for Content Type deserialization.");
		}
