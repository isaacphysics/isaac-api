...
public class APIOverviewResource {
        ...
        public void addMethod(String path, ResourceInvoker resourceInvoker) {
            if (resourceInvoker instanceof ResourceMethodInvoker) {
                ...
                for (String verb : method.getHttpMethods()) {
                    MethodDescription md = new MethodDescription(verb, path, produces, consumes, method.getMethod()
                    ...
                    if (!calls.contains(md)) {
                        ...
                        log.error("Duplicate interceptor detected. Check your application register. " + md.getMethod()
                                + " " + md.getFullPath());
                    }
                }
            }
    ...
    @Cache
    public Response getAvailableEndpointsHtml(@Context final HttpServletRequest request,
        ...
        Collections.sort(descriptions, new Comparator<ResourceDescription>() {
            ...
            @Override
            public int compare(final ResourceDescription o1, final ResourceDescription o2) {
        ...
        for (ResourceDescription resource : descriptions) {
            ...
            for (MethodDescription method : methodsList) {
                ...
                sb.append(
                        "<strong> <a href='" + "http://"
                                + properties.getProperty(uk.ac.cam.cl.dtg.segue.api.Constants.HOST_NAME) + "/api/"
