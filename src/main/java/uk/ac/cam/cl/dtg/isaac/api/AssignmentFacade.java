...
public class AssignmentFacade extends AbstractIsaacFacade {
    ...
    public Response getGroupAssignmentsProgressDownloadCSV(@Context final HttpServletRequest request,
        ...
        try {
            ...
            headerBuilder.append(String.format("Assignments for group '%s'\nDownloaded on %s\nGenerated by: %s %s\n\n",
                    group.getGroupName(), new Date(), currentlyLoggedInUser.getGivenName(), currentlyLoggedInUser.getFamilyName()));
