...
public class PgUserNotifications implements UserNotifications {
    ...
    @Override
    public List<UserNotification> getUserNotifications(final Long userId) throws SegueDatabaseException {
     ...
     */
    public UserNotification getNotification(final Long userId, final String contentId) throws SegueDatabaseException {
     ...
     */
    private UserNotification getNotificationRecord(final Long userId, final String contentId)
            throws SegueDatabaseException {
        try (Connection conn = database.getDatabaseConnection()) {
            PreparedStatement pst;
