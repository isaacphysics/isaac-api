...
public class IsaacQuestionsPageDTO extends SeguePageDTO {
    protected Float passMark;

    @JsonCreator
    public IsaacQuestionsPageDTO(@JsonProperty("_id") String _id, @JsonProperty("id") String id,
