...
import uk.ac.cam.cl.dtg.isaac.dto.content.GraphFormulaDTO;

/**
 * GraphFormula is a specialised choice object that allows a python expression representing the formula to be stored.
 *
 */
@DTOMapping(GraphFormulaDTO.class)
@JsonContentType("graphFormula")
public class GraphFormula extends Choice {
