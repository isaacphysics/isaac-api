...
public class GameboardsFacade extends AbstractIsaacFacade {
	...
	private static final Logger log = LoggerFactory
			.getLogger(GameboardsFacade.class);

	
	/**
	 * GamesFacade.
	 * For management of gameboards etc.
	 * 
	...
	public final Response getGameboard(
		...
		try {
			...
			Map<String, Map<String, List<QuestionValidationResponse>>> userQuestionAttempts =
					this.userManager.getQuestionAttemptsByUser(randomUser);
			...
			return Response.ok(gameboard).cacheControl(getCacheControl(NEVER_CACHE_WITHOUT_ETAG_CHECK))
					.tag(etag).build();
		} catch (IllegalArgumentException e) {
