 ...
 *
 */
public class IsaacSymbolicGraphValidator extends AbstractExternalValidator implements IValidator {
    ...
    public IsaacSymbolicGraphValidator(final String hostname, final String port) {
