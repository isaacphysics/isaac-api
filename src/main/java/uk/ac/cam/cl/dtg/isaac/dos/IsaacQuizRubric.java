 ...
 *
 */
@DTOMapping(IsaacQuizRubricDTO.class)
@JsonContentType("isaacQuizRubric")
public class IsaacQuizRubric extends Content {

    @JsonCreator
    public IsaacQuizRubric(@JsonProperty("id") String id,
