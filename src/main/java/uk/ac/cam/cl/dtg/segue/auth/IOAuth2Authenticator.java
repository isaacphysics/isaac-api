...
public interface IOAuth2Authenticator {
	 ...
	 * 
	 * @param email
	 *            - A string to help identify the user
	 * @return String - A url which should be fully formed and ready for the
	 *         user to login with - this should result in a callback to a
	 *         prearranged api endpoint if successful.
	 * @throws IOException
	...
	/**
	 * Step 2 of OAUTH2 - Get authorisation code from oauth provider using the
	...
	/**
	 * Step 3 of OAUTH2 - Exchange short term authorisation code for an access
	 ...
	 */
	public String exchangeCode(String authorizationCode) throws IOException,
			CodeExchangeException, NoUserIdException;
