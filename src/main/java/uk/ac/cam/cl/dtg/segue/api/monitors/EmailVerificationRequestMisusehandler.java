...
public class EmailVerificationRequestMisusehandler implements IMisuseHandler {
     ...
     */
    @Inject
    public EmailVerificationRequestMisusehandler(final EmailManager emailManager, final PropertiesLoader properties) {
    ...
    public void executeSoftThresholdAction(final String message) {
        final String subject = "Soft Threshold limit reached for verifyemail-request endpoint";
    ...
    public void executeHardThresholdAction(final String message) {
        final String subject = "HARD Threshold limit reached for verifyemail-request endpoint";
