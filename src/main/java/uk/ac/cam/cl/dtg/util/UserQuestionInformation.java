...
public class UserQuestionInformation {
    ...
    private final Queue<ContentDTO> mostRecentlyAttemptedQuestionPages = new CircularFifoQueue<>(PROGRESS_MAX_RECENT_QUESTIONS);
    ...
    private void incrementQuestionAttemptsByStageAndDifficulty(final Stage currentStage, final Difficulty currentDifficulty) {
    ...
    private void incrementQuestionsCorrectByStageAndDifficulty(final Stage currentStage, final Difficulty currentDifficulty) {
    ...
    public Map<String, Object> toMap(final UserSummaryDTO userOfInterestSummary, final Function<ContentDTO, ContentSummaryDTO> contentSummarisationFunction) {
