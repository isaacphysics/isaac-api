...
public class SegueContextNotifier implements ServletContextListener {
	...
	/**
	 * The constructor which will invoke use the Guice injector to get
	 * instances of everything that should be notified of any context messages.
	 */
	public SegueContextNotifier() {
		...
		// use guice to initialise everything that needs to be kept informed of the servlet context.
		for (Class<? extends ServletContextListener> segueListener : SegueGuiceConfigurationModule
				.getRegisteredContextListenerClasses()) {
