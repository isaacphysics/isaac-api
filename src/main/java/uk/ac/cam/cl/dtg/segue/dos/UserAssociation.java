...
/**
 * A UserAssociation represents the fact that a user has granted permissions to
 * view their users information to another user.
 * 
 */
public class UserAssociation {
	 ...
	 * UserAssociation.
	 * 
	 * @param id - unique identifier for the database use only.
	 * @param userIdGrantingPermission - The user who is granting permission (the owner of the data)
	 * @param userIdReceivingPermission - The user who is receiving access.
	 * @param created - date
	 */
