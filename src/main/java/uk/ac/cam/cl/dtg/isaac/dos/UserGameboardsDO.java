...
/**
 * Domain Object to store relationships between users and gameboards such that they can be shared etc.
 * 
...
public class UserGameboardsDO {
     ...
     * @param lastVisited
     */
    public UserGameboardsDO(final String id, final String userId, final String gameboardId, final Date created,
            final Date lastVisited) {
        this.id = id;
        this.userId = userId;
