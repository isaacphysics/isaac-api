...
import uk.ac.cam.cl.dtg.segue.api.userNotifications.WebsocketDependencyProvider;
...
public class IsaacApplicationRegister extends Application {
    ...
    public final Set<Object> getSingletons() {
        ...
        if (singletons.isEmpty()) {
            ...
            this.singletons.add(injector.getInstance(WebsocketDependencyProvider.class));
