...
public class AssignmentPersistenceManager {
     ...
     */
    public String saveAssignment(final AssignmentDTO assignment) throws SegueDatabaseException {
     ...
     *             - if there is an error when accessing the database.
     */
    public List<AssignmentDTO> getAssignmentsByOwnerIdAndGroupId(final String assignmentOwnerId, final String groupId)
            throws SegueDatabaseException {
     ...
     *             - if there is an error when accessing the database.
     */
    public List<AssignmentDTO> getAssignmentsByGameboardAndOwner(final String gameboardId, final String ownerId)
            throws SegueDatabaseException {
        Map<Entry<BooleanOperator, String>, List<String>> fieldsToMatchForAssignmentSearch = Maps.newHashMap();
     ...
     *             database..
     */
    public List<AssignmentDTO> getAssignmentsByGameboardAndGroup(final String gameboardId, final String groupId)
            throws SegueDatabaseException {
        Map<Entry<BooleanOperator, String>, List<String>> fieldsToMatchForAssignmentSearch = Maps.newHashMap();
     ...
     * findByMapConditions.
     * 
     * @param fieldsToMatchForAssignmentSearch
    ...
    private List<AssignmentDTO> findByMappedConditions(
            ...
            throws SegueDatabaseException {
        List<AssignmentDO> assignmentGroupDO = this.assignmentsDataManager.find(fieldsToMatchForAssignmentSearch);
