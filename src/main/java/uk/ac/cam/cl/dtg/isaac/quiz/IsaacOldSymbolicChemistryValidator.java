 ...
 */
@Deprecated
public class IsaacOldSymbolicChemistryValidator implements IValidator {
    private static final Logger log = LoggerFactory.getLogger(IsaacOldSymbolicChemistryValidator.class);
    ...
    public IsaacOldSymbolicChemistryValidator(final String hostname, final String port) {
    ...
    public QuestionValidationResponse validateQuestionResponse(final Question question, final Choice answer) throws ValidatorUnavailableException {
        ...
        if (feedback == null) {
            ...
            IsaacOldSymbolicChemistryValidator.MatchType closestMatchType = IsaacOldSymbolicChemistryValidator.MatchType.NONE;
            ...
            for (Choice c : orderedChoices) {
                ...
                IsaacOldSymbolicChemistryValidator.MatchType matchType;
                ...
                if (matchType == IsaacOldSymbolicChemistryValidator.MatchType.EXACT) {

                    // Found an exact match with one of the choices!

                    closestMatch = formulaChoice;
                    closestMatchType = IsaacOldSymbolicChemistryValidator.MatchType.EXACT;
                    break;
