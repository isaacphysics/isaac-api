...
public abstract class LogManagerEventPublisher implements ILogManager {
    ...
    /**
     *  Broadcast event to the subscriber
     *
     * @param user
     *            - abstract segue user who performed action
     * @param eventType
     *            - Type of event that we are interested in
     */
    private void raiseEvent(final AbstractSegueUserDTO user, final HttpServletRequest httpRequest, final String eventType, final Object eventDetails) {
    ...
    public void logEvent(final AbstractSegueUserDTO user, final HttpServletRequest httpRequest, final String eventType, final Object eventDetails) {
        ...
        this.raiseEvent(user, httpRequest, eventType, eventDetails);
    };
