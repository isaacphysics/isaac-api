...
-- Repeatable read is required to ensure the same users are moved into expired table as are deleted.
...
INSERT INTO expired_users SELECT id, family_name, given_name, email, date_of_birth, school_other, CURRENT_TIMESTAMP FROM users
