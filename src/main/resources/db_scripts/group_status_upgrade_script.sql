...
ALTER TABLE public.group_memberships ADD COLUMN status text DEFAULT 'ACTIVE'::text;
...
ALTER TABLE public.groups ADD COLUMN group_status text DEFAULT 'ACTIVE'::text;